...
RSpec.describe JiraTeamMetrics::DateRange do
  ...
  describe "#to_a" do
    ...
    context "if the end date is 1 day ahead of the start" do
      let(:range) { JiraTeamMetrics::DateRange.new(start_date, start_date + 1.day) }
    ...
    context "if the range spans multiple days" do
      let(:range) { JiraTeamMetrics::DateRange.new(start_date, start_date + 3.days) }
  ...
  describe "#overlap_with" do
    ...
    it "returns the overlap range" do
      other = JiraTeamMetrics::DateRange.new(start_date + 1.day, start_date + 3.days)
      expect(range.overlap_with(other)).to eq(JiraTeamMetrics::DateRange.new(start_date + 1.day, start_date + 2.days))
    end

    it "returns nil when a start time is missing" do
      other = JiraTeamMetrics::DateRange.new(nil, start_date + 3.days)
  ...
  describe "#duration" do
    it "returns the duration in days" do
      range = JiraTeamMetrics::DateRange.new(start_date, start_date + 1.5.days)
