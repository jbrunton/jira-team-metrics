  ...
  context "when some scope is predicted" do
    ...
    it "builds a CFD with predicted scope" do
      ...
      expect(data).to eq([
        ...
        ["Date(2018, 3, 1, 0, 0)", nil, 0, nil, nil, 0, 2, 1],
        ["Date(2018, 3, 2, 0, 0)", nil, 0, nil, nil, 1, 1, 1],
        ["Date(2018, 3, 3, 0, 0)", nil, 0, nil, nil, 2, 0, 1],
        ["Date(2018, 3, 4, 0, 0)", nil, 1, nil, nil, 1, 0, 1],
        ["Date(2018, 3, 5, 0, 0)", nil, 2, nil, nil, 0, 0, 1],
        ["Date(2018, 3, 6, 0, 0)", nil, 2, nil, nil, 0, 0, 1],
        ["Date(2018, 3, 7, 0, 0)", nil, 2, nil, nil, 0, 0, 1],
        ["Date(2018, 3, 8, 0, 0)", nil, 2, nil, nil, 0, 0, 1],
        ["Date(2018, 3, 9, 0, 0)", nil, 2.2857142857142856, nil, nil, 0, 0, 0.7142857142857143],
        ["Date(2018, 3, 10, 0, 0)", nil, 2.571428571428571, nil, nil, 0, 0, 0.4285714285714286],
        ["Date(2018, 3, 11, 0, 0)", nil, 2.857142857142857, nil, nil, 0, 0, 0.1428571428571429],
